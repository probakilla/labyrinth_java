...
public class Enemy extends AbstractCharacter implements Runnable {
	 ...
	 *
	 * The coordinates of the Enemy are set to [0,0]. The call of this constructor
	 * should be followed by randomizePosition().
	 */
	public Enemy() {
		super(0, 0);
		_imgPath = "/bad.png";
	 ...
	 *
	 * @param x
	 *            Abscissa in the labyrinth of the Enemy.
	 * @param y
	 *            Ordinate in the labyrinth of the Enemy.
	 */
